...
{
    TM1637_PORT_DIR |= (TM1637_CLK_PIN | TM1637_DAT_PIN);
...
{
    TM1637_OUT_PORT |= (TM1637_CLK_PIN | TM1637_DAT_PIN);
...
unsigned char TM1637_write_byte(unsigned char value)
{
	...
	TM1637_PORT_DIR &= ~TM1637_DAT_PIN;
	delay_us(TM1637_DELAY_US);

	ack = (TM1637_IN_PORT & TM1637_DAT_PIN);
